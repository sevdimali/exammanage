...
jQuery.offset = {
	setOffset: function( elem, options, i ) {
		...
		// Set position first, in-case top/left are set even on static_env elem
		if ( position === "static_env" ) {
...
jQuery.fn.extend( {
	...
	offsetParent: function() {
		return this.map( function() {
			...
			while ( offsetParent && jQuery.css( offsetParent, "position" ) === "static_env" ) {
...
(function( $, window, document, undefined ) {
	...
	/**
	 * Take the column definitions and static_env columns arrays and calculate how
	...
	{
		// Only extend API instances and static_env properties of the API
	...
	DataTable.defaults = {
		 ...
		 * during initialisation in addition to through the static_env
	...
	DataTable.ext = _ext = {
		 ...
		 * than just the static_env string that DataTables knows of.
		 * 
